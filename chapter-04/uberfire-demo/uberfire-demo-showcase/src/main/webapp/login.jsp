  ...
  <style type="text/css">
    * {
    ...
    #dummy {
      ...
      height: 250px;
      width: 100%;
      background: url('<%=request.getContextPath()%>/images/bg-login-top.png') repeat #9d9;
      z-index: 1;
    }
...
<div id="login-wrapper" class="png_bg">
  <div id="login-top">
    <img src="<%=request.getContextPath()%>/images/uf-demo.png" alt="UberFire demo" title="UberFire demo"/>
  </div>
