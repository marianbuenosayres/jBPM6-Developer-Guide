...
import com.wordpress.marianbuenosayres.interceptors.UserLogInterceptor;
import com.wordpress.marianbuenosayres.model.Requirement;

public class HumanTaskInterceptorTest {
    ...
    public void testLocalTaskService() throws Exception {
        ...
        //we should have another log (from the getTaskAssignedAsPotentialOwner method invocation)
        assertEquals(1, userLog.getLogs().size());
        assertEquals("GetTaskAssignedAsPotentialOwner", userLog.getLogs().get(0).getOperation());
        ...
        //each invocation should add one log
        assertEquals(2, userLog.getLogs().size());
        assertEquals("ClaimTask", userLog.getLogs().get(1).getOperation());
        ...
        //after the process is finished, these are all the logs we should find
        assertEquals(16, userLog.getLogs().size());
        assertEquals("StartTask", userLog.getLogs().get(2).getOperation());
        assertEquals("CompleteTask", userLog.getLogs().get(3).getOperation());
        assertEquals("GetTaskAssignedAsPotentialOwner", userLog.getLogs().get(4).getOperation());
        assertEquals("ClaimTask", userLog.getLogs().get(5).getOperation());
        assertEquals("StartTask", userLog.getLogs().get(6).getOperation());
        assertEquals("CompleteTask", userLog.getLogs().get(7).getOperation());
        assertEquals("GetTaskAssignedAsPotentialOwner", userLog.getLogs().get(8).getOperation());
        assertEquals("ClaimTask", userLog.getLogs().get(9).getOperation());
        assertEquals("StartTask", userLog.getLogs().get(10).getOperation());
        assertEquals("CompleteTask", userLog.getLogs().get(11).getOperation());
        assertEquals("GetTaskAssignedAsPotentialOwner", userLog.getLogs().get(12).getOperation());
        assertEquals("ClaimTask", userLog.getLogs().get(13).getOperation());
        assertEquals("StartTask", userLog.getLogs().get(14).getOperation());
        assertEquals("CompleteTask", userLog.getLogs().get(15).getOperation());
    }
}
